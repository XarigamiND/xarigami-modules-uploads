 ...
 * @param  $args ['override'] array optional override values for import/upload path/obfuscate (cfr. process_files)
  * @param  $args ['allow_duplicates'] 0- no, 1- new version, 2 - overwrite
 ...
 * @param  $args ['scale'] scale to a percentage of size
 * @param  $args ['resize_width'] pixel width
 * @param  $args ['resize_height'] pixel height
